...
const Command = require('../../Structures/Command'),
  { EmbedBuilder, ChannelType, GuildVerificationLevel, GuildExplicitContentFilter, GuildNSFWLevel } = require('discord.js');
    ...
    message.reply({
      embeds: [
        new EmbedBuilder()
          ...
          .addFields({ name: 'Description', value: `📝 ${guild.description || 'None'}` },
            {
              name: 'General',
              value: [
                `💳 **ID** ${guild.id}`,
